...
def add_contact():
    ...
    print("Enter the phone number, or leave empty: ")
    phone_input = input_correct_phone()
    while phone_input and len(phone_input) != 13:
        print("Invalid phone number. Please reenter a number.")
        phone_input = input_correct_phone()
    ...
    print("Enter the email, or leave empty: ")
    email_input = input_correct_email()
...
def del_phone():
    name = Name(input("Enter the name: "))
    print("Enter the phone number for delete: ")
    phone_del = Phone(input_correct_phone())
    while phone_del and len(phone_del) != 13:
        print("Invalid phone number. Please reenter a number.")
        phone_del = input_correct_phone()
    rec: Record = address_book.get(str(name))
    if rec:
...
def change_phone():
    name = Name(input("Enter the name: "))
    print("Enter the old phone number: ")
    old_phone = Phone(input_correct_phone())
    while old_phone and len(old_phone) != 13:
        print("Invalid phone number. Please reenter a number.")
        old_phone = input_correct_phone()
    print("Enter the new phone number: ")
    new_phone = Phone(input_correct_phone())
    while new_phone and len(new_phone) != 13:
        print("Invalid phone number. Please reenter a number.")
        new_phone = input_correct_phone()
    rec: Record = address_book.get(str(name))
    if rec:
